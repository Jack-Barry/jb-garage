  ...
  return (
    <Toast brToastFade aria-live="assertive" aria-atomic="true" ref={toast.ref}>
      <ToastHeader>
        ...
        <BrElement as="strong" bsJs={{ bsJsAll: { spacing: { margin: { end: 'auto' } } } }}>
          Bootstrap
        </BrElement>
...
export const LiveExample: StoryFn = () => {
  ...
  return (
    <div>
      ...
      <ToastContainer
        bsJs={{ bsJsAll: { spacing: { padding: '3' }, position: 'fixed' } }}
...
export const Stacking: StoryFn = () => {
  ...
  return (
    <ToastContainer bsJs={{ bsJsAll: { position: 'static' } }}>
...
export const ColorSchemes: StoryFn = () => {
  ...
  return (
    <Toast
      className="align-items-center"
      bsJs={{ bsJsAll: { border: false, color: 'bg-primary' } }}
      aria-live="assertive"
      aria-atomic="true"
      ref={toast.ref}
    >
